...
/**
 * Created by LMX on 2019/7/31 18:08
 */
@Controller
public class LoginController {
    ...
    public String login(@RequestParam(required = true) String email, @RequestParam(required = true) String password, HttpServletRequest httpServletRequest, Model model) {
        TbUser tbUser = tbUserService.log(email, password);
        ...
        // 登录成功
            ...
            // 将登录信息放入会话
            httpServletRequest.getSession().setAttribute(ContansUtils.SESSION_USER, tbUser);
