...
<div class="login-box">
    ...
    <div class="login-box-body">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input name="isRember"  type="checkbox"> 记住我
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <div class="social-auth-links text-center">
            ...
            <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> 使用Git登录</a>
        </div>
        <!-- /.social-auth-links -->
        <a href="#">忘记密码</a>
        <a href="register.html" class="text-center">注册账户</a>
